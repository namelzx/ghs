  ...
  <div class="detail-container">
    <div>
      <el-steps :active="order.status" finish-status="success" align-center>
        <el-step title="提交订单" :description="order.create_time" />
        <el-step title="订单支付" :description="formatTime(order.paymentTime)" />
    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
        <el-row>
          <el-col :span="4" class="table-cell-title">订单微信编号</el-col>
          <el-col :span="4" class="table-cell-title">平台单流水号</el-col>
        ...
        <el-row>
          <el-col :span="4" class="table-cell">{{ order.out_trade_no }}</el-col>
          <el-col :span="4" class="table-cell">{{ order.order_no }}</el-col>
        ...
        <el-row>
          ...
          <el-col :span="4" class="table-cell-title">自动收货时间</el-col>
          <el-col :span="4" class="table-cell-title">预计经理佣金</el-col>
          <el-col :span="4" class="table-cell-title">预计店长佣金</el-col>
        ...
        <el-row>
          ...
          <el-col :span="4" class="table-cell">{{ order.manager_price }}</el-col>
          <el-col :span="4" class="table-cell">{{ order.head_price }}</el-col>
      ...
      <div class="table-layout">
        ...
        <el-row>
          <el-col :span="8" class="table-cell">{{ order.buyerName }}</el-col>
          <el-col :span="8" class="table-cell">{{ order.mobile }}</el-col>

          <el-col :span="8" class="table-cell">{{ order.addressText }}</el-col>
      ...
      >
        <el-table-column label="商品图片" width="120" align="center">
          <template slot-scope="scope">
            <img :src="scope.row.images_url" style="height: 80px">
          </template>
        </el-table-column>
        ...
        <el-table-column label="小计" width="120" align="center">
          <template slot-scope="scope">
            ￥{{ scope.row.price*scope.row.totalBuyNum }}
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  created() {
    ...
    GetIdByDetails(this.id).then(response => {
