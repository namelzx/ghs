    ...
    >
      ...
      <el-table-column label="图标" width="150px" align="center">
        <template slot-scope="scope">
          <img :src="scope.row.ico" width="70px" height="70px">
        </template>
      </el-table-column>
      <el-table-column label="权益名称"       fixed="left"
      ...
      <!--| parseTime('{y}-{m}-{d} {h}:{i}')-->
      <el-table-column label="权益等级" min-width="80px"  align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.level }}</span>
        </template>
      </el-table-column>

      <el-table-column label="权益说明" min-width="130px"  align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.interests_desc }}</span>
        </template>
      </el-table-column>

      <el-table-column label="需要邀请人数" min-width="130px"  align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="权益状态" width="110px" align="center">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px"
        ...
        <el-form-item label="权益说明" >
          <el-input v-model="temp.interests_desc"/>
        </el-form-item>
        ...
        <el-form-item label="权益图标" prop="name">
          <Upload :imageUrl="temp.ico" @showParentComp="handelIco"/>
        </el-form-item>
...
<script>
  import {PostDataBySave, GetIdByDel, GetDataByList,GetCategory} from '@/api/userinterests'
