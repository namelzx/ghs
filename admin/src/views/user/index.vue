  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="头像"  align="center" min-width="100px">
        <template slot-scope="scope">
          <img class="headimgurl" :src="scope.row.headimgurl"/>
        </template>
      </el-table-column>

      <el-table-column label="成为会员时间"  align="center" min-width="80px">
        <template slot-scope="scope">
      ...
      <el-table-column label="操作" align="center" width="120px" class-name="small-padding">
        <template slot-scope="scope">
            <el-button    type="text" size="mini"
                       @click="handleUpdate(scope.$index,scope.row.id)">编辑</el-button>
