<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="分类id" prop="id"  align="center" min-width="80">
      ...
      <el-table-column label="分类状态" width="110px" align="center">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px"
        ...
        <el-form-item label="首页展示">
          ...
          <el-select v-model="temp.status_hm" class="filter-item" placeholder="Please select">
            <el-option v-for="(item,index) in HomeMap" :key="item.index" :label="item.name" :value="item.index" />
          </el-select>
        </el-form-item>
