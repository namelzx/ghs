  ...
  <el-card class="form-container" shadow="never">
    <el-form :model="homeAdvertise"
      ...
      <el-form-item label="广告图片：">
        ...
        <CoverImage :image-url="homeAdvertise.images_url" @showParentComp="HandelImages"/>
...
<script>
  ...
  import {PostDataBySave, getHomeAdvertise, updateHomeAdvertise} from '@/api/banner'
  ...
  export default {
    ...
    created(){
      if (this.isEdit) {
        ...
        console.log(id)
        getHomeAdvertise(id).then(response => {
    ...
    methods: {
      HandelImages(e) {
        this.homeAdvertise.images_url = e
      },
      onSubmit(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$confirm('是否提交数据', '提示', {
              ...
              if (this.isEdit) {
                PostDataBySave( this.homeAdvertise).then(response => {
