...
class Admin extends Model
{
     ...
     * 获取管理员列表
     */
    public function getLists($userName, $phone, $realName, $startTime, $endTime, $isEnabled, $myorder, $page, $psize,$groupId)
    {
        $where = true;
        if ($userName) {
    ...
    {
        return Db::name($table)->where($id, $val)->update([$field => $value]);
    }
